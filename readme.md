...
Tested up to: 4.7.3  
Stable version: 1.0    
Version: [1.0.3](https://github.com/epointal/lf-hiker/archive/v1.0.3.zip)    
...
After downloading the ZIP file [lf-hiker-1.0.3.zip](https://github.com/epointal/lf-hiker/archive/v1.0.3.zip)   
